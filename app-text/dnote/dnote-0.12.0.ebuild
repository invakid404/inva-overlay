...
EGO_SUM=(
	...
	"github.com/PuerkitoBio/goquery v1.6.0/go.mod"
	...
	"github.com/dnote/xgo v0.0.0-20200205013105-40be7d6d43ff"
	"github.com/dnote/xgo v0.0.0-20200205013105-40be7d6d43ff/go.mod"
	...
	"github.com/google/uuid v1.1.3/go.mod"
...
src_compile() {
	go build -mod=mod -tags="fts5" ./pkg/cli || die "compile failed"
}
