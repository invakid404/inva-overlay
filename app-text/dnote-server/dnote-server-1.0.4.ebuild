...
EGO_SUM=(
	...
	"github.com/dnote/actions v0.2.0/go.mod"
	"github.com/dnote/color v1.7.0"
	"github.com/dnote/color v1.7.0/go.mod"
	...
	"github.com/lib/pq v1.5.2/go.mod"
	...
	"github.com/rubenv/sql-migrate v0.0.0-20200429072036-ae26b214fa43/go.mod"
	...
	"golang.org/x/sys v0.0.0-20200513112337-417ce2331b5c/go.mod"
...
SRC_URI="https://github.com/dnote/dnote/archive/server-v1.0.4.tar.gz
	${EGO_SUM_SRC_URI}"
...
src_compile() {
	go build -mod=mod ./pkg/server || die "compile failed"
}
