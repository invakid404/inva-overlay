...
SRC_URI="https://github.com/evilmartians/lefthook/tarball/c89d3defd66ad448ebafe6d715866568d6b81fb4 -> lefthook-1.0.4-c89d3de.tar.gz
	${EGO_SUM_SRC_URI}"
...
post_src_unpack() {
	mv "${WORKDIR}"/evilmartians-lefthook-* "${S}" || die
}
