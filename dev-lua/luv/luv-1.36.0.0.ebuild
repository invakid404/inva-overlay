...
LUA_COMPAT_PV="0.9"
SRC_URI="
	https://github.com/luvit/luv/releases/download/1.36.0-0/luv-1.36.0-0.tar.gz -> ${P}.tar.gz
	https://github.com/keplerproject/lua-compat-5.3/archive/v0.9.tar.gz -> ${PN}-lua-compat-${LUA_COMPAT_PV}.tar.gz
"
