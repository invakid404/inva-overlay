...
SRC_URI="https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.12.0-no-jdk-linux-x86_64.tar.gz"
LICENSE="Apache-2.0 BSD-2 LGPL-3 MIT public-domain Elastic"
SLOT="0"
KEYWORDS="*"
