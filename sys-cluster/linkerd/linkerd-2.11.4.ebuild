...
EGO_SUM=(
	...
	"contrib.go.opencensus.io/exporter/ocagent v0.7.0/go.mod"
	...
	"github.com/!d!a!t!a-!d!o!g/go-sqlmock v1.5.0/go.mod"
	...
	"github.com/!make!now!just/heredoc v0.0.0-20170808103936-bb23615498cd/go.mod"
	...
	"github.com/!n!y!times/gziphandler v1.1.1/go.mod"
	"github.com/!one!of!one/xxhash v1.2.2/go.mod"
	"github.com/!puerkito!bio/purell v1.0.0/go.mod"
	"github.com/!puerkito!bio/purell v1.1.0/go.mod"
	"github.com/!puerkito!bio/purell v1.1.1"
	"github.com/!puerkito!bio/purell v1.1.1/go.mod"
	"github.com/!puerkito!bio/urlesc v0.0.0-20160726150825-5bd2802263f2/go.mod"
	...
	"github.com/!vivid!cortex/gohistogram v1.0.0/go.mod"
	...
	"github.com/briandowns/spinner v0.0.0-20190212173954-5cf08d0ac778/go.mod"
	...
	"github.com/emicklei/proto v1.9.2/go.mod"
	...
	"github.com/grpc-ecosystem/grpc-gateway v1.14.8/go.mod"
	...
	"github.com/linkerd/linkerd2-proxy-api v0.5.0/go.mod"
	"github.com/linkerd/linkerd2-proxy-init v1.5.3"
	"github.com/linkerd/linkerd2-proxy-init v1.5.3/go.mod"
	...
	"github.com/nsf/termbox-go v0.0.0-20180613055208-5c94acc5e6eb/go.mod"
	...
	"github.com/prometheus/common v0.33.0/go.mod"
	...
	"github.com/servicemeshinterface/smi-sdk-go v0.5.0/go.mod"
	...
	"github.com/shurcoo!l/vfsgen v0.0.0-20181202132449-6a9ea43bcacd/go.mod"
	...
	"k8s.io/apiextensions-apiserver v0.21.3/go.mod"
	...
	"k8s.io/apiserver v0.21.3/go.mod"
	...
	"k8s.io/kube-aggregator v0.21.3/go.mod"
...
SRC_URI="
    https://github.com/linkerd/linkerd2/tarball/7b3ebd22d57b300a4baa7f11356fdd8353ae72e1 -> linkerd2-2.11.4-7b3ebd2.tar.gz
	${EGO_SUM_SRC_URI}
"
...
post_src_unpack() {
	rm -rf ${S}
	mv "${WORKDIR}"/linkerd-linkerd2-* "${S}" || die
}
