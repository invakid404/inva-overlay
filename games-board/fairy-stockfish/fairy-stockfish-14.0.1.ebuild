...
SRC_URI="https://github.com/ianfab/Fairy-Stockfish/tarball/433d4115a31ebcf0d9c0e4238b12915b70a0b7c1 -> Fairy-Stockfish-14.0.1-433d411.tar.gz"
...
post_src_unpack() {
    mv "${WORKDIR}"/ianfab-Fairy-Stockfish-*/src "${S}" || die
}
