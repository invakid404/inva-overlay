...
SRC_URI="https://api.github.com/repos/official-stockfish/Stockfish/tarball/sf_13 -> Stockfish-13.tar.gz
...
src_unpack() {
	...
	mkdir -p ${S}
	mv ${WORKDIR}/official-stockfish-Stockfish-*/* ${S}/../ || die
}

src_prepare() {
	default

	cp "${DISTDIR}"/nn-62ef826d1a6d.nnue nn-62ef826d1a6d.nnue || die "copying the nnue file failed"
