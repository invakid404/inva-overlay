...
SRC_URI="https://github.com/kovidgoyal/kitty/archive/f6e518d2f97c6dc660997bb85a40d0469e5df852.tar.gz
	https://github.com/kovidgoyal/kitty/releases/download/v0.23.1/kitty-0.23.1.tar.xz"
KEYWORDS="*"
...
src_unpack() {
	unpack ${A}
	mv ${WORKDIR}/kitty-0.23.1/docs/_build ${WORKDIR}/docs_build || die
	rm -rf ${WORKDIR}/kitty-0.23.1
	rm -rf ${S}
